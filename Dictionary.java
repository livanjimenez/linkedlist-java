...
public class Dictionary {
    ...
    public static void viewMenu(WordList newDictionary) {
        ...
        if (response1 == 0) {
            ...
            if (newDictionary.deletedWords.size() == 0) {
                int resultant = JOptionPane.showOptionDialog(null, "No Deleted Words", "Error",
    ...
    public static void viewDictionary(WordList newDictionary) {
        ...
        int response2 = JOptionPane.showOptionDialog(null, "Choose an Option", "Edit/View Dictionary",
        ...
        case 0:
            try {
                ...
                if (!addWord.equalsIgnoreCase("") && addWord != null) {
                    ...
                    String addDef = JOptionPane.showInputDialog(null,
                            "Type the definition you would like to add to " + addWord);
                    addDef.toLowerCase();
                    while (addDef.equalsIgnoreCase("") || addDef == null) {
                        addDef = JOptionPane.showInputDialog(null,
                                "Type the definition you would like to add to " + addWord);
                    }
                ...
                JOptionPane.showMessageDialog(null, "Empty Input Option Found", "Blasphemous Error",
